...
module.exports = async function(deployer, a, account) {
    ...
    // const proxyAdmin= '0x0F9399FC81DaC77908A2Dde54Bb87Ee2D17a3373'; // Testchange
    // const ifoAdmin= '0x35f16A46D3cf19010d28578A8b02DfA3CB4095a1'; // Testchange

    // const lpToken = '0xA527a61703D82139F8a06Bc30097cC9CAA2df5A6'; //cake-bnb // Testchange
    // const offeringToken = '0x63870a18b6e42b01ef1ad8a2302ef50b7132054f'; //blk // Testchange
    ...
    const proxyAdmin= '0x111e465f00cA7Ec4585ef57ff475C4b5b8eF9F3B';
    const ifoAdmin= '0x111e465f00cA7Ec4585ef57ff475C4b5b8eF9F3B';

    const lpToken = '0x5633bC039257EF4e1B7437ab3c84984ACD20a94C'; //cake-bnb
    const offeringToken = '0xa8F27D0AA5474698541A759E21eBed119B7571c8'; //blk
    const startBlock = '2401100';
    const endBlock = '2402320';
    const offeringAmount = numAsHex;
    const raisingAmount = numAsHex1;
